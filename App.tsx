...
export default function App() {
  ...
  const snapPoints = useMemo(() => ['40%', '20%'], []);
  ...
  return (
    <SafeAreaView style={[styles.container, {backgroundColor: isOpen ? '#00000050' : '#fff'}]}>
      ...
      <View style={styles.shadow}>
        ...
        >
          <Text style={{color: '#0080FB', fontSize: 16, fontWeight: '600'}}>Getting</Text>
        </TouchableOpacity>
      <BottomSheet
